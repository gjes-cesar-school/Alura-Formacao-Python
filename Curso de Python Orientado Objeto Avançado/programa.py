...
print(f"Tamanho da Playlist: {len(playlist_fim_de_semanda.listagem)}")

for programas in playlist_fim_de_semanda.listagem:
    print(programas)
   
print(f"Tá ou não tá? {demolidor in playlist_fim_de_semanda.listagem}")
